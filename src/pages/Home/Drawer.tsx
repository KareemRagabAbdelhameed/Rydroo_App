...
<div className="flex justify-center space-x-6 mt-6">
  ...
  {/* Instagram Official Logo with Yellow → Red → Pink Gradient */}
  ...
  >
    <defs>
      <linearGradient id="ig-gradient" x1="0" y1="1" x2="1" y2="0">
        <stop offset="0%" stopColor="#FEDA75" />   {/* Yellow */}
        <stop offset="40%" stopColor="#FA7E1E" />  {/* Orange/Red */}
        <stop offset="70%" stopColor="#D62976" />  {/* Pink */}
        <stop offset="100%" stopColor="#962FBF" /> {/* Violet لمسة بسيطة */}
      </linearGradient>
    </defs>
